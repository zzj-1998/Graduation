...
export default class UI_ShopWnd extends fgui.GComponent {
	...
	public static URL:string = "ui://n1eyqnayqkssi1";

	public static createInstance():UI_ShopWnd {
		return <UI_ShopWnd>(fgui.UIPackage.createObject("Main", "ShopWnd"));
	}
